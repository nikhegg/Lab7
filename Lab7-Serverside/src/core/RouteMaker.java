...
public class RouteMaker {
     ...
     * @return
     */
    public Route makeNewRoute(ConsolerMode mode, User user) {
        ...
        return new Route(Globals.getRoutesCreated(), name.trim(), cords, java.time.ZonedDateTime.now(), locationOne, locationTwo, distance, user);
    }
}
